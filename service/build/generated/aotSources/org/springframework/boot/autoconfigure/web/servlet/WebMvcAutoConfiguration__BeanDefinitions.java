...
public class WebMvcAutoConfiguration__BeanDefinitions {
   ...
   */
  public static class ProblemDetailsErrorHandlingConfiguration__BeanDefinitions {
    /**
    ...
    public static BeanDefinition getProblemDetailsErrorHandlingConfigurationBeanDefinition() {
      Class<?> beanType = WebMvcAutoConfiguration.ProblemDetailsErrorHandlingConfiguration.class;
      RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    ...
    /**
     * Get the bean instance supplier for 'problemDetailsExceptionHandler'.
     */
    private static BeanInstanceSupplier<ProblemDetailsExceptionHandler> getProblemDetailsExceptionHandlerInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<ProblemDetailsExceptionHandler>forFactoryMethod(WebMvcAutoConfiguration.ProblemDetailsErrorHandlingConfiguration.class, "problemDetailsExceptionHandler")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean(WebMvcAutoConfiguration.ProblemDetailsErrorHandlingConfiguration.class).problemDetailsExceptionHandler());
    }

    /**
     * Get the bean definition for 'problemDetailsExceptionHandler'.
     */
    public static BeanDefinition getProblemDetailsExceptionHandlerBeanDefinition() {
      Class<?> beanType = ProblemDetailsExceptionHandler.class;
      RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
      beanDefinition.setInstanceSupplier(getProblemDetailsExceptionHandlerInstanceSupplier());
      return beanDefinition;
    }
  }
